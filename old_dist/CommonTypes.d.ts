...
export declare function populatedRef(where: string): (target: any, propertyKey: string) => void;
...
export declare const EVENT_NEW = "new";
export declare const EVENT_GET = "get";
export declare const EVENT_STARTUP = "startup";
